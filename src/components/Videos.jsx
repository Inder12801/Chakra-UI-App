    ...
    <Stack direction={['column', 'row']} h={'100vh'} p={'4'}>
      <VStack w={'full'}>
        ...
        <VStack w={'full'} p={'8'} alignItems={'flex-start'} overflowY={'auto'}>
          ...
          <Text>
            gSDFUSJ SFB ILAFGFUSDFUGFVBUY WETFGL gSDFUSJ SFB ILAFGFUSDFUGFVBUY
            WETFGL gSDFUSJ SFB ILAFGFUSDFUGFVBUY WETFGL gSDFUSJ SFB WETFGL
          </Text>
        </VStack>
      </VStack>
      <VStack w={['full', 'xl']} alignItems={'stretch'} p={'8'}>
        <Heading w={'fit-content'} m={'10px auto'}>
          Lectures
        </Heading>
